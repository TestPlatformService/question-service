...
func (x *CreateTopicReq) GetQuestionCount() int32 {
	if x != nil {
...
func (x *UpdateTopicReq) GetQuestionCount() int32 {
	if x != nil {
		return x.QuestionCount
	}
	return 0
...
var file_topic_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x71, 0x75, 0x65, 0x73, 0x74, 0x69, 0x6f,
